...
- Developed based on [cc-switch](https://github.com/farion1231/cc-switch/), originally forked from commit `395783e22a0bcd530ab883b9d8784d537c5ffac3` and currently merged through upstream tag `v3.12.3`; data format remains compatible with cc-switch.
