...
function App() {
  ...
  const {
    ...
    takeoverStatus,
    status: proxyStatus,
  } = useProxyStatus({ serverId: currentServer?.id ?? null });
  ...
  const showServerHome = isOnServerHome && currentView === "providers";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
            ...
            {showServerHome ? (
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  title={t("server.backToList", {
                    defaultValue: "返回服务器列表",
                  })}
                >
                  <ArrowLeft className="w-4 h-4" />
                </Button>
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <span className="text-sm font-medium">
                    {currentServer?.name ||
                      t("server.unknown", { defaultValue: "未知服务器" })}
                  </span>
                </div>
          ...
          <div className="flex flex-1 min-w-0 items-center justify-end gap-1.5">
            ...
            <div
              ref={toolbarRef}
              className="flex flex-1 min-w-0 overflow-hidden items-center gap-2"
            >
              {!showServerHome && currentView === "providers" && (
                <div
      ...
      <main className="flex-1 min-h-0 flex flex-col overflow-y-auto animate-fade-in">
        {!showServerHome &&
          isOpenClawView &&
          openclawHealthWarnings.length > 0 && (
